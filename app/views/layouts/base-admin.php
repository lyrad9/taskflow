...
<html>
<head>
<title><?php echo isset($data['title']) ? $data['title'] : 'Dashboard Administrateur'; ?></title>
...
<body>
   ...
   <!-- Main Content -->   
        ...
        <?php $this->renderPartial("admin/{$data["content"]}", $data); ?>
        </div>
        </div>
    </div>
    <script>
...
<script src="/public/assets/js/search-type-project.js"></script>
<script src="/public/assets/js/display-btn-status-project.js"></script>
